...
There's also an option that matches characters that 
...
Your regex chewieRegex should use the * character to match
...
Your regex should not match any characters in the string
